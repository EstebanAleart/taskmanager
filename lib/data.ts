...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tasksTotal: 12,
    tasksDone: 10,
    members: [TEAM_MEMBERS[2], TEAM_MEMBERS[3]],
    color: "bg-amber-500",
  },
  {
    id: "p4",
...
export const INITIAL_TASKS: Task[] = [
  ...
  },
  {
    ...
    files: makeFiles("t2", "Disenar landing page", [
      { name: "landing-mockup-v3.png", type: "image", size: "2.8 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-01" },
      { name: "landing-copy.docx", type: "doc", size: "45 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-01-28" },
      { name: "color-palette.png", type: "image", size: "180 KB", uploadedBy: TEAM_MEMBERS[3], date: "2026-01-27" },
      { name: "brand-guidelines.pdf", type: "pdf", size: "5.4 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-01-26" },
      { name: "competitor-analysis.xlsx", type: "spreadsheet", size: "320 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-01-25" },
      { name: "wireframes-v2.pdf", type: "pdf", size: "1.8 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-01-29" },
      { name: "hero-animation.mp4", type: "video", size: "12.5 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-02" },
      { name: "typography-specs.pdf", type: "pdf", size: "890 KB", uploadedBy: TEAM_MEMBERS[3], date: "2026-01-30" },
    ]),
  ...
  },
  {
    ...
    files: makeFiles("t6", "Flujo de onboarding N8N", [
      { name: "workflow-diagram.png", type: "image", size: "420 KB", uploadedBy: TEAM_MEMBERS[0], date: "2026-02-03" },
      { name: "n8n-export.json", type: "other", size: "12 KB", uploadedBy: TEAM_MEMBERS[0], date: "2026-02-03" },
      { name: "onboarding-email-template.docx", type: "doc", size: "56 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-04" },
    ]),
  ...
  },
  {
    ...
    files: makeFiles("t7", "Manual de marca", [
      { name: "manual-marca-draft.pdf", type: "pdf", size: "8.2 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-02" },
      { name: "logos-pack.zip", type: "other", size: "15.6 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-01" },
      { name: "paleta-colores.png", type: "image", size: "290 KB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-01" },
      { name: "tipografia-seleccion.pdf", type: "pdf", size: "1.1 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-03" },
      { name: "iconografia-v1.png", type: "image", size: "560 KB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-03" },
    ]),
    createdAt: "2026-02-01",
  },
  {
    ...
    files: makeFiles("t8", "A/B Testing campana email", [
      { name: "resultados-ab-test.xlsx", type: "spreadsheet", size: "245 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-05" },
      { name: "variante-a-screenshot.png", type: "image", size: "380 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-04" },
      { name: "variante-b-screenshot.png", type: "image", size: "410 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-04" },
      { name: "informe-final.pdf", type: "pdf", size: "2.1 MB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-05" },
    ]),
  ...
  },
  {
    ...
    files: makeFiles("t11", "Sync con Hubspot via N8N", [
      { name: "hubspot-mapping.xlsx", type: "spreadsheet", size: "95 KB", uploadedBy: TEAM_MEMBERS[0], date: "2026-01-28" },
      { name: "sync-flow-diagram.png", type: "image", size: "550 KB", uploadedBy: TEAM_MEMBERS[0], date: "2026-01-29" },
    ]),
  ...
  },
  {
    ...
    files: makeFiles("t12", "Contenido redes sociales", [
      { name: "calendario-feb.xlsx", type: "spreadsheet", size: "120 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-01" },
      { name: "post-instagram-01.png", type: "image", size: "1.8 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-02" },
      { name: "post-instagram-02.png", type: "image", size: "2.1 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-02" },
      { name: "copy-linkedin.docx", type: "doc", size: "34 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-03" },
      { name: "reel-promo.mp4", type: "video", size: "28.4 MB", uploadedBy: TEAM_MEMBERS[3], date: "2026-02-04" },
      { name: "hashtag-research.docx", type: "doc", size: "22 KB", uploadedBy: TEAM_MEMBERS[2], date: "2026-02-01" },
    ]),
    createdAt: "2026-02-01",
  },
];
